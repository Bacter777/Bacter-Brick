package com.terbac.ahuk.brick.ui;
...
import com.terbac.ahuk.brick.surfaceViews.GameView1;
import com.terbac.ahuk.brick.surfaceViews.GameView2;
import com.terbac.ahuk.brick.ui.about.AboutActivity;
...
public class Main extends CustomAppCompatActivity implements Runnable, View.OnTouchListener{
    ...
    private final ImageView[] mButton = new ImageView[8];
    private final TextView[] mText = new TextView[5];
